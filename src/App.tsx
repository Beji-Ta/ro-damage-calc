...
const ENEMY_LIST: EnemyData[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'tetra_vortex', name: 'テトラボルテックス', type: 'magic',    element: '闇',     powerMultiplier: 4.0, hits: 4, notes: '4ヒット合計 ※倍率近似値' },
...
const ELEMENT_TABLE: Record<string, Record<string, number>> = {
  '無属性': { '無属性': 100, '火': 100, '水': 100, '地': 100, '風': 100, '毒': 100, '聖': 100, '闇': 100, '念':  25, '不死': 100 },
  '火':     { '無属性': 100, '火':  25, '水':  50, '地': 150, '風':  75, '毒':  75, '聖': 125, '闇': 125, '念':  25, '不死':  50 },
  '水':     { '無属性': 100, '火': 150, '水':  25, '地':  75, '風':  50, '毒': 100, '聖': 100, '闇': 100, '念':  25, '不死': 100 },
  '地':     { '無属性': 100, '火':  75, '水': 125, '地':  25, '風': 150, '毒': 100, '聖': 100, '闇': 100, '念':  25, '不死': 100 },
  '風':     { '無属性': 100, '火':  50, '水':  75, '地': 125, '風':  25, '毒': 100, '聖': 100, '闇': 100, '念':  25, '不死': 100 },
  '毒':     { '無属性': 100, '火': 100, '水': 100, '地': 100, '風': 100, '毒':  25, '聖':  50, '闇': 100, '念':  25, '不死':  75 },
  '聖':     { '無属性': 100, '火': 100, '水': 100, '地': 100, '風': 100, '毒':  50, '聖':   0, '闇': 200, '念':  25, '不死': 200 },
  '闇':     { '無属性': 100, '火': 100, '水': 100, '地': 100, '風': 100, '毒': 100, '聖': 200, '闇':   0, '念':  25, '不死': 100 },
  '念':     { '無属性': 100, '火': 100, '水': 100, '地': 100, '風': 100, '毒':  25, '聖': 100, '闇': 100, '念':   0, '不死': 100 },
  '不死':   { '無属性': 100, '火':  50, '水': 100, '地': 100, '風': 100, '毒':  25, '聖': 200, '闇': 100, '念':  25, '不死':   0 },
}
...
function calcDamage(stats: PlayerStats, enemy: EnemyData): DamageResult[] {
  ...
  return enemy.skills.map(skill => {
    ...
    const armorElemMod    = ELEMENT_TABLE[armorLookupElem]?.[stats.armorElement] ?? 100
